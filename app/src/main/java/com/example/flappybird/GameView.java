...
public class GameView extends View {
    ...
    private void initBird() {
        ...
        bird.setHeight(120 * Constants.SCREEN_HEIGHT / 1920);
        bird.setX(120 * Constants.SCREEN_WIDTH / 1080);
        ...
        if (start) {
            ...
            for (int i = 0; i < sumObstacles; i++) {
                if (bird.getRect().intersect(arrObstacles.get(i).getRect()) || bird.getY() - bird.getHeight() < 0 || bird.getY() > Constants.SCREEN_HEIGHT) {
                    Obstacles.speed = 0;
                    Home.txtScoreOver.setText(Home.txtScore.getText());
                    Home.txtTopScore.setText("Top Score : " + topScore);
                    Home.txtScore.setVisibility(INVISIBLE);
                    Home.PanelGameOver.setVisibility(VISIBLE);
                ...
                if (this.bird.getX() + this.bird.getWidth() > arrObstacles.get(i).getX() + arrObstacles.get(i).getWidth() / 2
                    ...
                    Home.txtScore.setText("Score : " + score);
